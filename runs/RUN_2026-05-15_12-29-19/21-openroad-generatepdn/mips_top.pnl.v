module mips_top (clk,
 ...
 sky130_fd_sc_hd__dfxtp_2 _197_ (.CLK(clk),
    ...
    .VPWR(VPWR),
    .Q(pc_out[31]));
 sky130_fd_sc_hd__conb_1 _198_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(alu_result_out[0]));
 sky130_fd_sc_hd__conb_1 _199_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(alu_result_out[1]));
 sky130_fd_sc_hd__conb_1 _200_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(alu_result_out[2]));
 sky130_fd_sc_hd__conb_1 _201_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(alu_result_out[3]));
 sky130_fd_sc_hd__conb_1 _202_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(alu_result_out[4]));
 sky130_fd_sc_hd__conb_1 _203_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(alu_result_out[5]));
 sky130_fd_sc_hd__conb_1 _204_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(alu_result_out[6]));
 sky130_fd_sc_hd__conb_1 _205_ (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(alu_result_out[7]));
